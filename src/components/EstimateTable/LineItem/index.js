    ...
    <tr key={index}>
      ...
      <th>
        ...
        <input
          ...
          step="0.01"
          placeholder="Cost"
          defaultValue={lineItem.partCost}
          onInput={(e) =>
            updateLineItem({
              id: lineItem.id,
              property: "partCost",
      ...
      <th>
        <input
          ...
          defaultValue={lineItem.partNumber}
          onInput={(e) =>
            updateLineItem({
              id: lineItem.id,
              property: "partNumber",
      ...
      <th>
        <input
          ...
          step="1"
          placeholder="Labor"
          defaultValue={lineItem.laborHours}
          onInput={(e) =>
            updateLineItem({
              id: lineItem.id,
              property: "laborHours",
      ...
      <th>
        ${lineItem.partCost * lineItem.quantity + lineItem.laborHours * 160}
      </th>
      <th>
